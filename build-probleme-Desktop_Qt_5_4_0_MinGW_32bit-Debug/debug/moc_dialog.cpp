...
QT_MOC_LITERAL(1, 7, 12), // "envoyerTemps"
...
QT_MOC_LITERAL(5, 28, 21) // "on_pushButton_clicked"
    ...
    "Dialog\0envoyerTemps\0\0idx\0tp\0"
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->envoyerTemps((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog::envoyerTemps)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Dialog::envoyerTemps(int _t1, QString _t2)
{
