...
#include "../../probleme/utilisateur.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Utilisateur_t, stringdata) + ofs \
...
const QMetaObject Utilisateur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Utilisateur.data,
      qt_meta_data_Utilisateur,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Utilisateur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Utilisateur.stringdata))
